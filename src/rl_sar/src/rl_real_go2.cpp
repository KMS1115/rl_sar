...
bool IsFaultOverrideSuppressed(const RL_Real& rl)
{
...
std::vector<float> RL_Real::GetJointFaultVector() const
{
...
void RL_Real::BeginReleaseTransition(int leg_idx, const RobotCommand<float>* command)
{
...
float RL_Real::GetFaultReleasePhaseDuration() const
{
...
void RL_Real::StartPolicyResumeTransition(const RobotCommand<float>* command)
{
...
void RL_Real::UpdatePendingFaultSwitch(const RobotCommand<float>* command)
{
    (void)command;
...
void RL_Real::CycleFaultMode(const RobotCommand<float>* command)
{
    (void)command;
...
void RL_Real::ApplyFaultCommand(RobotCommand<float> *command)
{
    ...
    if (IsFaultOverrideSuppressed(*this))
    {
        return;
    }
